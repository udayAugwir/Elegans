Shader "Splatmap/Splatmap12DiffColor"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf (Input IN, inout SurfaceOutput o)
		{
			...
			fixed4 splatMap03 = tex2D(_SplatMap03, TRANSFORM_TEX(IN.myUV, _SplatMap03)).rgba;
			...
			fixed3 albedo09 = tex2D(_Albedo09, TRANSFORM_TEX(IN.myUV, _Albedo09)).rgb;
			fixed3 albedo10 = tex2D(_Albedo10, TRANSFORM_TEX(IN.myUV, _Albedo10)).rgb;
			fixed3 albedo11 = tex2D(_Albedo11, TRANSFORM_TEX(IN.myUV, _Albedo11)).rgb;
			fixed3 albedo12 = tex2D(_Albedo12, TRANSFORM_TEX(IN.myUV, _Albedo12)).rgb;
